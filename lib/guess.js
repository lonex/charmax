...
_.each(db, function(v) {
    console.log(util.displayCssConfig(v) + " => " + v["max"]);
});
...
var ret = match(test);
console.log(">>>");
console.log(util.displayCssConfig(test));
console.log(ret);
...
function match(cssProp) {
    ...
    var found = _.find(db, function(opt) {
        console.log("   >> check " + util.displayCssConfig(opt));
...
function bestValue(name, values, realValue) {
    console.log("::bestValue name " + name + ", values " + values + ", realValue " + realValue);
...
function bestNumericValue(values, realValue) {
    ...
    console.log("   :;bestNumericValue i " + i );
